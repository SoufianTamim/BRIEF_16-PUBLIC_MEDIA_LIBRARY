...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 09 mars 2023 à 16:57
...
(2, 'PANIQUE DANS LA FORET', 'Clotilde Perrin', 'Item_Images/Audio_Book/1297509.jpg', 'Used', '2013-03-27', '2019-07-10', 'Available', 0, 3),
...
(18, 'SOUL', 'Docter Pete', 'Item_Images/Movie/V99999006516.jpg', 'Used', '2019-07-25', '2020-01-21', 'Available', 0, 4),
...
(21, 'APRES LA CHUTE', 'Pierre-Henry Gomont', 'Item_Images/Comic/074ac8ed6b3c596776004f8e338af83bde47944d27e07e69ea5ea3cdc3a1a173.jpg', 'New', '2022-01-25', '2022-01-26', 'Borrowed', 0, 5),
...
(32, 'FEVER DREAMS PTS 1-4', 'Johnny Marr', 'Item_Images/Music/4050538706109_thumb.jpg', 'Used - like new', '2020-09-11', '2021-11-30', 'Available', 0, 2),
(33, 'THE GLEAM', 'Park Jiha', 'Item_Images/Music/1228680.jpg', 'Used', '2018-07-25', '2019-01-24', 'Available', 0, 2),
(34, 'SHOALS', 'Palace', 'Item_Images/Music/0602438712960_thumb.jpg', 'Used - like old', '2017-06-23', '2017-09-16', 'Available', 0, 2),
...
(41, 'LE LIVRE SANS IMAGES', 'B. J. Novak', 'Item_Images/Book/2bef76287385920bb9770bb454d9cceef5571f9d8e6d45cf6c28bedcae8711f7.jpg', 'New', '2022-03-25', '2022-03-26', 'Reserved', 0, 1),
...
(43, 'L\'ETE OU TOUT A FONDU : ROMAN', 'Tiffany McDaniel', 'Item_Images/Book/c45078e0f10b727bf5360f5fa86673f3f88333fc71106104fd903f8b310a6a68.jpg', 'Used', '2018-06-07', '2019-03-20', 'Reserved', 0, 1),
...
(47, 'UNE SURPRISE POUR AMOS MCGEE', 'Philip Christian', 'Item_Images/Book/079bd8ff61271504db3d7dbfbe7fc46f2f4c08a87ab4fb7da7a36f02c4135780.jpg', 'New', '2022-01-11', '2022-02-09', 'Available', 0, 1),
...
(50, 'L\'ECOLE N\'EST PAS FAITE POUR LES PAUVRES ', 'Jean-Paul Delahaye', 'Item_Images/Book/21711074dc6316af8f3428a1e0e5348da54f8f86c708e0f3af8279a20ed0f121.jpg', 'Used - like old', '2019-03-01', '2019-04-01', 'Available', 0, 1),
(86, 'Quas animi in est q', 'Ut earum in cum non ', '/Item_Images/1297509.jpg', 'Used - like old', '2014-02-22', '2017-03-25', 'Available', 14, 1),
...
('alilousaad1975', 'Alilou Saad', '$2y$10$JLZPL6qxKGsYcKY9g6nXpeArQ1owcSWcbmK02Hh5kyLaEmZkxhsYO', 1, '27, av. Hassan II444', 'alilou.saad@gmail.comm', '+212695621537', 'K143659', 'Responsable', 0, '1975-04-22', '2015-06-09'),
('bkhitamine2000', 'Bkhit Amine', '$2y$10$JLZPL6qxKGsYcKY9g6nXpeArQ1owcSWcbmK02Hh5kyLaEmZkxhsYO', 0, '20, rue Bani Marine', 'bkhit.amine@gmail.c', '+21268402183822', 'CE45691834', 'Etudiant', 1, '2000-01-04', '2022-07-09'),
...
(2952, '2023-03-09 16:12:44', '2023-03-10 16:12:44', 43, 'bkhitamine2000'),
(2953, '2023-03-09 16:22:15', '2023-03-10 16:22:15', 42, 'bkhitamine2000'),
(2954, '2023-03-09 16:22:18', '2023-03-10 16:22:18', 41, 'bkhitamine2000');
...
--
ALTER TABLE `borrowings`
  MODIFY `Borrowing_Code` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
...
--
ALTER TABLE `item`
  MODIFY `Item_Code` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=88;

--
-- AUTO_INCREMENT pour la table `reservation`
--
ALTER TABLE `reservation`
  MODIFY `Reservation_Code` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2956;

    ...
    <div class="d-flex flex-wrap  bg-dark p-2 rounded-2 m-1" id="card">
      <div class = "product-img cont image " >
        <img src = "../<?php echo $val['Cover_Image'] ?>" id="image" class = "image img-fluid d-block mx-auto" height="400px !important">
                            ...
                            <span class = " m-1 text-uppercase"><?php echo $vale['Reservation_Date'] ?></span>
                            <span class = " m-1 text-success"><?php echo $vale['Reservation_Expiration_Date'] ?></span>
                            <span class = " m-1 text-uppercase"><?php echo $val['Title'] ?></span>
                            <span class = " m-1 text-success"><?php echo $val['Status'] ?></span>
                            <form action="" method="GET">
                              <input type="submit" <?php if(!isset($val['Status']) || $val['Status'] !== "Reserved") { echo "hidden"; } ?> class="btn btn-outline-primary text-white" value="Active Reservation" name ="Active_Reservation">
